...
# GET - запрашивает данные из определенного ресурса
# POST - отправляет данные для обработки на определенный ресурс
# PUT - обновляет данные на определенном ресурсе или создает новый ресурс, если он не существует
# PATCH - частично обновляет данные на определенном ресурсе
